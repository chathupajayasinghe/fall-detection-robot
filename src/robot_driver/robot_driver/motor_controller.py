...
class MotorController(Node):
    def __init__(self):
        ...
        # --- Robot Parameters ---
        self.wheel_separation = 0.17  # meters (empirical effective separation for tracked chassis; physical measurement 0.135m, adjusted for track scrub from 90° rotation tests reporting 114–115°)
        self.wheel_radius = 0.027      # meters (encoder calibration: 1343 and 1389 ticks over two 1.0 m tape-measured drives (~1360 ticks/m))
